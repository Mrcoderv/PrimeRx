...
(function () {
    ...
    const features = [
        ...
        { name: 'Ageing Dues',        route: '/Due/Index',              icon: 'bi-clock-history', category: 'Due' },
        ...
        { name: 'Ageing Payables',    route: '/Admin/Payables/Index',    icon: 'bi-clock-history', category: 'Admin' },
